  ...
  useEffect(() => {
    ...
    const unsubscribe = onValue(loanRequestsRef, (snapshot) => {
      ...
      if (data) {
        ...
        const deniedLoanRequests = formattedData.filter(
          (request) => request.status === "denied"
        );
        
        setLoanRequests(deniedLoanRequests);
      } else {
        setLoanRequests([]);
      }
    });
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <Text style={styles.headerTextLeft}>Admin</Text>
      ...
      <ScrollView contentContainerStyle={styles.main}>
        {loanRequests.length === 0 ? (
          <Text style={styles.noDataText}>No denied loan requests available.</Text>
        ) : (
      ...
      <View style={styles.footer}>
        ...
        <TouchableOpacity style={styles.iconButton} onPress={() => router.push("/Splash")}>
